  ...
  return (
    ...
    >
      <div className="relative bg-bg-1 border border-green-dim rounded-2xl p-[26px_24px] max-w-[340px] w-full text-right">
        ...
        <h2 className="font-display text-2xl text-green m-0 mb-3 text-center">طرز بازی موردل</h2>

        <p className="text-ivory-dim text-sm leading-7 mb-3">
          هر روز ۵ سوال می‌بینی. تو هر سوال دو تا چیز نشونت داده می‌شه، باید حدس بزنی کدوم عدد
          بزرگ‌تره.
        </p>

        <ul className="text-ivory-dim text-sm leading-7 mb-3 pr-4 list-disc space-y-1 text-right">
          <li>روی کارتی که فکر می‌کنی عددش بزرگ‌تره بزن.</li>
          <li>بعد از هر جواب، عدد واقعی هر دو طرف نشون داده می‌شه.</li>
          <li>در آخر، امتیازت به‌صورت X از ۵ نشون داده می‌شه.</li>
