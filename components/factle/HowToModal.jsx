  ...
  return (
    ...
    >
      <div className="relative bg-bg-1 border border-green-dim rounded-2xl p-[26px_24px] max-w-[340px] w-full text-right">
        ...
        <h2 className="font-display text-2xl text-green m-0 mb-3 text-center">طرز بازی فکتل</h2>

        <p className="text-ivory-dim text-sm leading-7 mb-3">
          هر روز یک کشور مرموز انتخاب می‌شه. یک سرنخ درباره‌ش می‌بینی و باید حدس بزنی این سرنخ مال
          کدوم کشوره؛ در ۶ تلاش.
        </p>

        <ul className="text-ivory-dim text-sm leading-7 mb-3 pr-4 list-disc space-y-1 text-right">
          <li>اسم کشور رو تایپ کن و از بین پیشنهادها انتخابش کن.</li>
          <li>هر بار که اشتباه حدس بزنی، یه سرنخ جدید و ساده‌تر نشون داده می‌شه.</li>
          <li>فقط یک بار در روز می‌تونی بازی کنی؛ سرنخ‌های امروز برای همه یکسانه.</li>
          <li>بازی جدید هر روز ساعت ۹ شب به وقت ایران منتشر می‌شه؛ یعنی کشور همون موقع عوض می‌شه.</li>
        </ul>
